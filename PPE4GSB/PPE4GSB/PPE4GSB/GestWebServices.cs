...
namespace PPE4GSB
{
    public class GestWebServices
    {
        ...
        {
            response = await ws.GetStringAsync("http://paris2.ingetis.fr/SLAM_2019/SEIGLER_Alan/Situation_2_Cas_GSB/UpdateIndividu.php?code=" + Code_Type + "&libelle=" + Libelle_Type);
        }
    }
}
